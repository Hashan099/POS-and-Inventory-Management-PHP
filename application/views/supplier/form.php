      ...
      <div class="row">
        <div class="col-xs-12">
          <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="<?php echo site_url('supplier/create');?>">Add </a></li>
            <li role="presentation"><a href="<?php echo site_url('supplier');?>">Suppliers List </a></li>
          </ul>
              ...
              <div class="box-body">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="col-sm-4 control-label" for="kode">Supplier Code</label>
                    <div class="col-sm-8">
